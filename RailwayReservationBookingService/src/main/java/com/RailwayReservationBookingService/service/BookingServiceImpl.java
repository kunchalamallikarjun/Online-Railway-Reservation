...
public class BookingServiceImpl implements BookingService {
	...
	public void sendEmail(long pnrNo) throws AddressException {
		...
		final Email email = DefaultEmail.builder().from(new InternetAddress("mkunchala8@gmail.com"))
				.replyTo(new InternetAddress("mkunchala8@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("mkunchala8@gmail.com")))
