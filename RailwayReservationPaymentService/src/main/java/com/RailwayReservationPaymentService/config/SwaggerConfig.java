...
public class SwaggerConfig {
	...
	private ApiInfo getApiInfo() {
		return new ApiInfo("User API Documentation", "API for User Booking Microservice", "1.0", "Free to use",
				new springfox.documentation.service.Contact("Mallikarjun A T", "http://Youtube.com",
						"mkunchala8@gmail.com"),
